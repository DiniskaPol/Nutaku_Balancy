...
namespace Nutaku.Unity
{
    public static class RestApi
    {
        ...
        public const string DefaultGuidMe = "@me";
        public const string DefaultSelectorSelf = "@self";
        public const string DefaultAppId = "@app";

        /// <summary>
        /// People API.
        /// </summary>
        /// <param name="guid">Required. DefaultGuidMe or a Nutaku user ID.</param>
            ...
            UnityWebRequestUtil.callbackFunctionDelegate callbackFunctionDelegate)
        {
            ...
            Request<Person>(
                ...
                queryParams,
                null,
                (oauthKind == OAuthKind.ThreeLegged || guid == DefaultGuidMe) ? SdkPlugin.loginInfo.userId : null,
                oauthKind,
                myMonoBehaviour,
            ...
            UnityWebRequestUtil.callbackFunctionDelegate callbackFunctionDelegate)
        {
            if (string.IsNullOrEmpty(guid))
                throw new ArgumentException("guid must not be Null or Empty");
            if (guid == DefaultGuidMe)
                throw new ArgumentException("guid must not be " + DefaultGuidMe);
            ...
            Request<Payment>(
                "GET",
                "payment",
                new List<string> { guid, DefaultSelectorSelf, DefaultAppId, paymentId },
                queryParams,
                null,
                (guid == DefaultGuidMe) ? SdkPlugin.loginInfo.userId : null,
                OAuthKind.TwoLegged,
                myMonoBehaviour,
                callbackFunctionDelegate);
        }
            ...
            UnityWebRequestUtil.callbackFunctionDelegate callbackFunctionDelegate)
        {
            ...
            Request<Payment>(
               "POST",
               "payment",
               new List<string> { DefaultGuidMe, DefaultSelectorSelf, DefaultAppId },
               queryParams,
               payment,
